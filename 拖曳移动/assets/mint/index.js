        ...
        onDrag: function (t) {
          ...
          if (this.dragging) {
            var e, n = t.changedTouches ? t.changedTouches[0] : t,
              ...
              a = Math.abs(i),
              r = Math.abs(s);
            if (this.setAnimations("0ms"), "" === this.direction && (this.direction = r > a ? "horizonal" : "vertical"), "horizonal" === this.direction) {
              if (t.preventDefault(), t.stopPropagation(), e = !(r < 5 || r >= 5 && a >= 1.73 * r), !e) return;
              s < 0 && -s > this.rightWidth || s > 0 && s > this.leftWidth || s > 0 && !this.leftWidth || s < 0 && !this.rightWidth || this.swipeMove(s)
            }
          }
        },
        endDrag: function () {
        ...
        initEvents: function () {
          ...
          n.i(i.a)(o, {
            ...
            drag: function (n) {
              ...
              r.dragging = !1;
              var n, i, a = 7,
                u = s.a.getElementTranslate(o).top,
                c = new Date - l.start,
              ...
              r.$nextTick(function () {
                var t;
                t = p ? Math.round(p / h) * h : Math.round(u / h) * h, t = Math.max(Math.min(t, m[1]), m[0]), s.a.translateElement(o, null, t), r.currentValue = r.translate2Value(t), r.rotateEffect && r.planUpdateRotate()
              }), l = {}
            }
          })
        },
    ...
    e.default = {
      ...
      methods: {
        ...
        rafTranslate: function (t, e, n, i, s) {
          function a() {
            return Math.abs(o - n) < .5 ? (this.animating = !1, o = n, t.style.webkitTransform = "", s && (s.style.webkitTransform = ""), cancelAnimationFrame(l), void(i && i())) : (o = r * o + (1 - r) * n, t.style.webkitTransform = "translate3d(" + o + "px, 0, 0)", s && (s.style.webkitTransform = "translate3d(" + (o - n) + "px, 0, 0)"), void(l = requestAnimationFrame(a.bind(this))))
          }
          var r = .88;
          this.animating = !0;
          var o = e,
        ...
        doAnimate: function (t, e) {
          ...
          if (0 !== this.$children.length && (e || !(this.$children.length < 2))) {
            ...
            setTimeout(function () {
              "next" === t ? (s.isDone = !0, s.before(o), c ? s.rafTranslate(o, u, -l, g, r) : (s.translate(o, -l, d, g), r && s.translate(r, 0, d))) : "prev" === t ? (s.isDone = !0, s.before(o), c ? s.rafTranslate(o, u, l, g, a) : (s.translate(o, l, d, g), a && s.translate(a, 0, d))) : (s.isDone = !1, s.translate(o, 0, d, g), "undefined" != typeof u ? (a && u > 0 && s.translate(a, l * -1, d), r && u < 0 && s.translate(r, l, d)) : (a && s.translate(a, l * -1, d), r && s.translate(r, l, d)))
            }, 10)
          }
        },
        next: function () {
